...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        data = filtered_df['class'].astype(str)
        fig = px.pie(data,
            names='class',
...
def get_scatter_plot(entered_site, payload_mass):
    ...
    if entered_site == 'ALL':
        data = spacex_df[['class', 'Payload Mass (kg)', 'Booster Version Category']]
        ...
        fig = px.scatter(data, x='Payload Mass (kg)', y='class', color="Booster Version Category", title=f'Correlation between Payload and Success for site {entered_site}')
        return fig
